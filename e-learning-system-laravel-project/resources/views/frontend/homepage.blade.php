<x-frontend.master>
    <x-forms.message />
    <!-- slider section -->
    <x-frontend.carousel.carousel :carousels="$carousels" />
    <!-- end slider section -->
    </div>
    <!-- why section -->
    ...
    <!-- course section -->
    <section class="product_section layout_padding" id="our-courses">
        <div class="container">
            <div class="heading_container heading_center">
                <h2>
                            ...
                            <div class="option_container">
                                <div class="options">
                                    ...
                                    <a href="#" class="option2">
                                        <form method="post" action="{{ route('courses.cart.store', $course->id) }}">
                                            @csrf
                    ...
                    <div class="carousel-item active">
                        <div class="box col-lg-10 mx-auto">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Dignissimos reprehenderit repellendus nobis error quibusdam? Atque animi sint
                                    unde
                                    quis reprehenderit, et, perspiciatis, debitis totam est deserunt eius officiis
                                    ipsum
