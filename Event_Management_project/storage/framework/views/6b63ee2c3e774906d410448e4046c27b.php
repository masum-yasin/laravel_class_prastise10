        ...
        <div class="schedule-item">
            ...
            <div class="about-image-box bg-white mb-4">
                <div class="row">
                    ...
                    <div class="col-lg-3 d-flex">
                        <div class="schedule-speaker d-lg-flex p-4 align-items-center text-center text-lg-start w-100 border-start">
                            <img src="frontend/assets/images/reviewer/2.jpg" alt="" class="rounded-circle img-circle">
                            <div class="speaker-content ms-3">
            ...
            <div class="about-image-box bg-white mb-4">
                <div class="row">
                    ...
                    <div class="col-lg-3 d-flex">
                        <div class="schedule-speaker d-lg-flex p-4 align-items-center text-center text-lg-start w-100 border-start">
                            <img src="frontend/assets/images/reviewer/3.jpg" alt="" class="rounded-circle img-circle">
                            <div class="speaker-content ms-3">
...
<section class="event-calltoaction pb-0" style="background-image: url(frontend/assets/images/pexels-sascha.jpg);">
    <div class="container">
        ...
        <div class="video-expo w-75 mx-auto position-relative mb-minus">
            <img src="frontend/assets/images/blog/blog1.jpg" alt="" class="p-2 bg-white">
...
<section class="event-gallery pb-0 pt-18" style="background-image: url(frontend/assets/images/speaker_bg.png);">
    <div class="container">
        <div class="section-title mb-5 w-75 mx-auto text-center">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 ps-lg-5">
                <div class="testimonial-image">
                    <img src="frontend/assets/images/testi-image.png" alt="" class="opacity-50">
                </div>
            </div>
        </div>
    </div>
...
<!-- partner starts -->
<section class="event-partners pb-8" style="background-image: url(frontend/assets/images/contentbg.png);">
    <div class="container">
        <div class="section-title mb-5 w-75 mx-auto text-center">
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp8\htdocs\wdpf55_laravel\Event_Management_project\resources\views/frontend/home.blade.php ENDPATH**/ ?>