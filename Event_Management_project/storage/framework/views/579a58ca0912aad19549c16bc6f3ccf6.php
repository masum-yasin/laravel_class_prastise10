					...
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form method="POST" action="<?php echo e(route('login')); ?>">
							...
							<div class="row pb-30">
								...
								<div class="col-6">
									<div class="forgot-password"><a href="backend.forgetpassword">Forgot Password</a></div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
...
</html><?php /**PATH F:\xampp8\htdocs\wdpf55_laravel\Event_Management_project\resources\views/backend/login.blade.php ENDPATH**/ ?>